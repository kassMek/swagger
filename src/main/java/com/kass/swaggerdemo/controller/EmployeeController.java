package com.kass.swaggerdemo.controller;

import com.kass.swaggerdemo.domain.Article;
import com.kass.swaggerdemo.domain.Employee;
import com.kass.swaggerdemo.exception.ResourceNotFoundException;
import com.kass.swaggerdemo.repository.EmployeeRepository;
import com.kass.swaggerdemo.service.ArticleService;
...
public class EmployeeController {
    ...
    public List<Employee> getAllEmployees() {
        logger.debug("inside getAllEmployees() method");
        return employeeRepository.findAll();

    }
    @ApiOperation(value = "Get an employee by Id")
    @GetMapping("/employees/{id}")
    public ResponseEntity<Employee> getEmployeeById(  @ApiParam(value = "Employee id from which employee object will retrieve", required = true)
